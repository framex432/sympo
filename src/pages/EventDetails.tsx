...
export default function EventDetails() {
  ...
  return (
    <div className="relative">
      ...
      {/* =====================================================
          HERO / EVENT HEADER + IMAGE SLIDER
      ====================================================== */}
            ...
            <div className="w-full">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-hull2">
                ...
                <img
                  ...
                  className="w-full h-[260px] sm:h-[360px] lg:h-[410px] object-cover"
                />
                ...
                {images.map((image, index) => (
                  <button
                    ...
                    className={`relative overflow-hidden rounded-xl border transition-all duration-300 ${
                      activeImage === index
                        ? 'border-nebula-cyan shadow-[0_0_18px_rgba(0,220,255,0.35)]'
                  ...
                  >
                    ...
                    <img
                      ...
                      className="w-full h-[80px] sm:h-[100px] lg:h-[105px] object-cover"
                    />

                    {/* Active overlay */}
                    {activeImage === index && (
                      <span className="absolute inset-0 bg-nebula-cyan/10 pointer-events-none" />
                    )}
        ...
        <div className="container-xn grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <p className="text-sm text-mist leading-relaxed">
                ...
                {event.mandatory ? (
                  <>
                    This is XENO 2K26&rsquo;s{' '}
                    <span className="text-starlight font-medium">
                      mandatory flagship event
                    </span>{' '}
                    — {registrationLogic.amount} registration here is required
                    for every participant, and it also unlocks your pick of{' '}
                    {registrationLogic.freePicks} more events, free.
                  </>
                ) : (
                  <>
                    This event is{' '}
                    ...
                    — it&rsquo;s included the moment you register for Ideathon (
                    {registrationLogic.amount}) and choose it as one of your{' '}
                    {registrationLogic.freePicks} picks.
                  </>
                )}
              ...
              <ul className="space-y-3">
                ...
                {event.highlights.map((h, i) => (
                  ...
                  >
                    <CheckCircle2
                      size={16}
                      className="text-nebula-cyan shrink-0 mt-0.5"
                    />
            ...
            <div className="card-surface p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-mist/60 uppercase tracking-wide">
                  Coordinator
                </p>
          ...
          <div>
            ...
            <div className="card-surface p-6 sticky top-28">
              ...
              {/* QUICK INFO REGISTER BUTTON - KEEP */}
              <a
                href="https://forms.gle/RpJVv6rKi8npie4t5"
                target="_blank"
                rel="noopener noreferrer"
