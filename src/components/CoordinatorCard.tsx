  ...
  if (size === 'small') {
    return (
      <div className="flex flex-col items-center text-center gap-2.5 group">
        ...
        <div>
          <p className="text-sm font-semibold text-starlight leading-tight">
            {person.name}
          </p>
        ...
        <div className="flex items-center gap-3 mt-1">
          ...
          {person.phone && (
            <a
              ...
              className="w-8 h-8 rounded-full bg-hull2 flex items-center justify-center text-nebula-cyan hover:text-nebula-gold transition-colors"
