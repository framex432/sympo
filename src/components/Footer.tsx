    ...
    <footer className="relative bg-hull text-starlight/90 mt-24 border-t border-hairline">
      ...
      <div className="container-xn py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-sm text-mist leading-relaxed">
            {symposiumInfo.type} by the {symposiumInfo.departments},{' '}
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-mist">
            ...
            <li className="flex items-start gap-2.5">
              <Phone
                size={15}
                className="mt-0.5 text-nebula-cyan shrink-0"
              />
              <span>
                {symposiumInfo.phone}
                <br />
                {symposiumInfo.altPhone}
              </span>
            </li>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/sinc.nagai/"
              target="_blank"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/sir-issac-newton-college-of-engineering-and-technology/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-hairline flex items-center justify-center hover:border-nebula-cyan/60 hover:text-nebula-cyan transition-colors"
              aria-label="SINCET LinkedIn"
            >
              <Linkedin size={15} />
            </a>
      ...
      <div className="hairline">
        <div className="container-xn py-5 text-xs text-mist/50 text-center">
          © 2026 {symposiumInfo.collegeName}. All Rights Reserved. This website
          collects no personal data — registration happens via QR on the
          Register page.
        </div>
      </div>
